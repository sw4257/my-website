      ...
      <div class="container">
        <div class="row">
          <div class="content-sec">
              ...
              <a href="<?php echo esc_url($techup_banner_button_link1); ?>" class="readmore-btn"><?php echo esc_html($techup_banner_button_label1); ?><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
              <?php } ?>
            </div>
             <?php endif; ?>
          </div>
