...
$businessexpo_footer_copyright = get_theme_mod( 'businessexpo_footer_copyright_enabled', 'true' );
	...
	$businessexpo_footer_copyright_text = get_theme_mod( 'businessexpo_footer_copright_text', __( 'Copyright &copy; 2022 | Powered by <a href="//wordpress.org/">WordPress</a> <span class="sep"> | </span> BusinessExpo theme by <a target="_blank" href="//wpfrank.com/">WP Frank</a>', 'businessexpo' ) );
?>
	<?php
