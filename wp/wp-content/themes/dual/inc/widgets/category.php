 ...
 * @package Dual
 */
if ( !function_exists('dual_category_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function dual_category_widgets(){
        // Recent Post widget.
        register_widget('Dual_Sidebar_Category_Widget');
    }
endif;
add_action('widgets_init', 'dual_category_widgets');
// Recent Post widget
if ( !class_exists('Dual_Sidebar_Category_Widget') ) :
    /**
     * Recent Post.
     *
     * @since 1.0.0
     */
    class Dual_Sidebar_Category_Widget extends Dual_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'dual_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'dual'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'dual'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'dual'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
            );
            parent::__construct('dual-category-layout', esc_html__('Dual: Category Widget', 'dual'), $opts, array(), $fields);
        }
        /**
        ...
        function widget( $args, $instance ){
            ...
            if( $slug_counts ){
                ...
                <div class="widget-content twp-category-widget">
                    <div class="theme-widget-list category-widget-list">
                    <?php
                        $i = 1;
