	...
	function () {
		...
		theme_conrols.on(
			...
			function () {
				...
				if (parentid == 'customize-control-businessexpo_funfact_content') {
					var numItems = jQuery( "#customize-control-businessexpo_funfact_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 4) {
						jQuery( "#customize-control-businessexpo_funfact_upgrade .businessexpo-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-businessexpo_team_content') {
					var numItems = jQuery( "#customize-control-businessexpo_team_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 3) {
						jQuery( "#customize-control-businessexpo_team_upgrade .businessexpo-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-businessexpo_client_content') {
					var numItems = jQuery( "#customize-control-businessexpo_client_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 4) {
						jQuery( "#customize-control-businessexpo_client_upgrade .businessexpo-upgrade-pro-message" ).show();
						return false;
					}
				}
				...
				if (typeof    jQuery( this ).parent() !== 'undefined') {
					jQuery( this ).parent().hide(
						...
						function(){
							...
							var funfact_items = jQuery( "#customize-control-businessexpo_funfact_content .customizer-repeater-general-control-repeater-container" ).length
							if (funfact_items < 4) {
								jQuery( "#customize-control-businessexpo_funfact_upgrade .businessexpo-upgrade-pro-message" ).hide();
							}
							var team_items = jQuery( "#customize-control-businessexpo_team_content .customizer-repeater-general-control-repeater-container" ).length
							if (team_items < 3) {
								jQuery( "#customize-control-businessexpo_team_upgrade .businessexpo-upgrade-pro-message" ).hide();
							}
							var client_items = jQuery( "#customize-control-businessexpo_client_content .customizer-repeater-general-control-repeater-container" ).length
							if (client_items < 5) {
								jQuery( "#customize-control-businessexpo_client_upgrade .businessexpo-upgrade-pro-message" ).hide();
							}
